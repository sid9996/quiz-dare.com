(function(E) {
    ...
    */
    ...
    var ha = function(a) {
        ...
        ka;
    if (ea && "function" == typeof Object.setPrototypeOf) ka = Object.setPrototypeOf;
    else {
        var la;
        a: {
            var na = {
    ...
    p("Map", function(a) {
        ...
        c.prototype.forEach = function(h, k) {
            for (var l = this.entries(), q; !(q = l.next()).done;) q = q.value, h.call(k, q[1], q[0], this)
        };
        ...
        var d = function(h, k) {
                ...
                if (q && v(h.h, l))
                    for (h = 0; h < q.length; h++) {
                        var ma = q[h];
                        if (k !== k && ma.key !== ma.key || k === ma.key) return {
                            id: l,
                            list: q,
                            index: h,
                            m: ma
    ...
    var gb = /^(?:audio\/(?:3gpp2|3gpp|aac|L16|midi|mp3|mp4|mpeg|oga|ogg|opus|x-m4a|x-matroska|x-wav|wav|webm)|font\/\w+|image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp|x-icon)|video\/(?:mpeg|mp4|ogg|webm|quicktime|x-matroska))(?:;\w+=(?:\w+|"[\w;,= ]+"))*$/i,
        ...
        fb = {},
        jb = new z("about:invalid#zClosurez", fb);
    var A;
    a: {
        var kb = w.navigator;
        if (kb) {
    ...
    var nb = function(a) {
        ...
        sb = function(a, b) {
                        ...
                        if (null != d) {
                            ...
                            if (d instanceof Ka) d = La(d);
                                ...
                                if (c.toLowerCase() in qb)
                                    ...
                                    else if (d instanceof z) d = d instanceof z && d.constructor === z ? d.i : "type_error:SafeUrl";
                                else if ("string" === typeof d) d instanceof z || (d = "object" == typeof d && d.u ? d.g() : String(d), ib.test(d) ? d = new z(d, fb) : (d = String(d), d = d.replace(/(%0A|%0D)/g, ""), d = (f = d.match(hb)) && gb.test(f[1]) ? new z(d, fb) : null)), d = (d || jb).g();
                                else throw Error("");
                            }
                            d.u && (d = d.g());
                            c = c + '="' + cb(String(d)) + '"';
            ...
            !0 === Ha.script ? g += ">" : (b = rb(e), g += ">" + nb(b).toString() + "\x3c/script>", b = b.h());
        ...
        mb = {},
        tb = new B(w.trustedTypes && w.trustedTypes.emptyHTML || "", 0, mb);
    var vb = function(a, b) {
            a.write(nb(b))
        },
        xb = function() {
            a: {
                var a = w.document;
                if (a.querySelector && (a = a.querySelector("script[nonce]")) && (a = a.nonce || a.getAttribute("nonce")) && wb.test(a)) break a;a = ""
            }
            return a
        },
        wb = /^[\w+/_-]+[=]{0,2}$/;
    ...
    var C = function() {},
            ...
            if (c)
                for (b = 0; b < c.length; b++)
                    if (e = c[b], e < a.l) {
                        ...
                        var f = a.h[e];
                        f ? Hb(f) : a.h[e] = Lb
                    } else Mb(a), (f = a.j[e]) ? Hb(f) : a.j[e] = Lb;
            if (d && d.length)
                for (c = 0; c < d.length; c++) Nb(a, d[c])
        },
        Lb = Object.freeze(Hb([])),
        Mb = function(a) {
            var b = a.l + a.i;
        ...
        F = function(a, b) {
            ...
            if (a.j) return c = a.j[b], c !== Lb ? c : a.j[b] = Hb([])
        },
        G = function(a, b, c) {
            a = F(a, b);
            return null == a ? c : a
        ...
        Qb = function(a, b, c) {
            a.g || (a.g = {});
            c = c || [];
            for (var d = Hb([]), e = 0; e < c.length; e++) d[e] = Pb(c[e]);
            a.g[b] = c;
            H(a, b, d)
        },
        Rb = function(a) {
        ...
        Tb = function(a, b) {
            switch (typeof b) {
                ...
                case "object":
                    if (Eb && null != b && b instanceof Uint8Array) return Bb(b)
            }
            return b
        };
    ...
    var ec = function(a, b) {
            if (!bc() && !cc()) {
                var c = Math.random();
                if (c < b) return c = dc(w), a[Math.floor(c * a.length)]
            }
            return null
        },
        dc = function(a) {
        ...
        cc = za(function() {
            return Array.prototype.some.call(["Google Web Preview", "Mediapartners-Google", "Google-Read-Aloud", "Google-Adwords"], gc, void 0) || 1E-4 > Math.random()
        }),
        bc = za(function() {
            return gc("MSIE")
        }),
    ...
    var ad = function(a, b, c, d, e, f) {
        ...
        bd = function(a, b, c, d) {
            ad(a ? new Wb(9 == a.nodeType ? a : a.ownerDocument || a.document) : ya || (ya = new Wb), b, 0, !1, void 0 === c ? function() {} : c, void 0 === d ? function() {} : d)
        };
    var cd = function(a) {
            this.g = a;
            this.h = null
    ...
    var fd = function(a, b) {
        var c = a.document,
            d = a ? new Wb(9 == a.nodeType ? a : a.ownerDocument || a.document) : ya || (ya = new Wb),
            e = function() {
                if (!a.frames[b])
                    if (c.body) {
    ...
    var wd = vd.aa,
        ...
        zd = function(a, b) {
            ...
            if (d && (b = (b = b[c]) && b[d])) {
                ...
                if (null != a) {
                    if (6 === b) return e === a;
                    if (9 === b) return null != e && 0 === eb(String(e), a);
                    if (d) switch (b) {
                        case 7:
                            return e < a;
                        case 8:
    ...
    var S = function(a) {
        ...
        oe = function(a) {
            ...
            T(me, function(b) {
                for (var c = M(R), d = r([wd, O, P]), e = d.next(); !e.done; e = d.next()) e = e.value, wa(c.g[e], b[e])
            }, a)
        },
        pe = function(a) {
    ...
    var Ce = [12, 13, 20],
        ...
        Fe = function(a, b, c) {
            if (a.l[b]) return .001 >= Math.random() && oc({
                b: c,
                dp: b
            }, "tagging_dupdiv"), !0;
            a.l[b] = !0;
        ...
        Je = function(a, b, c) {
            var d = [],
                e = Ge(a.j, b);
            if (9 !== b && Fe(a, b, c) || !e.length) return d;
            var f = Fa(Ce, b);
            Aa(e, function(g) {
                if (g = He(a, g, c)) {
                    var h = g.getId();
        ...
        He = function(a, b, c) {
            ...
            return c.length ? (b = G(b, 4, 0)) ? Ne(a, b, f, c) : Me(a, c, f / 1E3) : null
        },
        Ne = function(a, b, c, d) {
    ...
    var Ye = w.performance,
        Ze = !!(Ye && Ye.mark && Ye.measure && Ye.clearMarks),
        $e = za(function() {
            var a;
            if (a = Ze) a = rd(), a = !!a.indexOf && 0 <= a.indexOf("1337");
            return a
        });
    ...
    var xf = function() {
            ...
            if (N(Gc) && !window.google_plmetrics && window.PerformanceObserver) {
                ...
                for (var b = r(["layout-shift", "largest-contentful-paint", "first-input", "longtask"]), c = b.next(); !c.done; c = b.next()) c = c.value, vf(a).observe({
                    type: c,
                    buffered: !N(Kc)
                });
                wf(a)
        ...
        vf = function(a) {
            a.G || (a.G = new PerformanceObserver(kf(640, function(b) {
                var c = yf !== window.scrollX || zf !== window.scrollY ? [] : Af,
                    d = Bf();
                b = r(b.getEntries());
                for (var e = b.next(); !e.done; e = b.next()) switch (e = e.value, e.entryType) {
                    case "layout-shift":
                        var f = a;
                        if (!e.hadRecentInput && (!N(Hc) || .01 < e.value)) {
                            f.A += Number(e.value);
    ...
    var Cf = function(a) {
            if (!a.T) {
                ...
                for (var c = 0, d = r(document.getElementsByTagName("iframe")), e = d.next(); !e.done; e = d.next()) nf(e.value) && c++;
                b += X("nif", c);
                ...
                b += "&top=" + (w === w.top ? 1 : 0);
                if (a.V) c = "&qqid=" + encodeURIComponent(a.V);
                else {
                    if ("number" !== typeof w.goog_pvsid) try {
        ...
        Bf = function() {
            var a = [].concat(t(document.getElementsByTagName("iframe"))).filter(nf),
                b = [].concat(t(mf())).map(function(c) {
        ...
        Nf = function(a, b, c) {
            ...
            return window.fetch(d, {
                ...
                if (e && "NoModificationAllowedError" === e.name) {
                    if (Y(a, b.issuerOrigin, 10), c) return Mf(a, b)
                } else Y(a, b.issuerOrigin, 9)
            })
        },
        Of = function(a) {
                    ...
                    if (d || e) {
                        var f = document.hasTrustToken(c.issuerOrigin).then(function(g) {
                            if (g) {
                                ...
                                if (e) return Nf(a, c, d);
                                Y(a, c.issuerOrigin, 3)
                            }
                        });
                        b.push(f)
                    } else Y(a, c.issuerOrigin, 7)
                });
                if (window.Promise && window.Promise.all) return window.Promise.all(b)
            }
        };
    var Pf = "platform platformVersion architecture model uaFullVersion bitness".split(" "),
        Qf = function(a) {
    ...
    function bg() {
        ...
        1 > a || Math.floor(a) !== a ? (oc({
            v: "2021063001"
        }, "gpt_inv_ver"), a = "1") : a = "2021063001";
        return a
    };
    var Re = function() {
        var a = {};
    ...
    var eg = function(a) {
        ...
        lg = function(a, b, c) {
            a.g = b;
            a.h = c;
            for (var d = r(a.j), e = d.next(); !e.done; e = d.next()) e = e.value, e(b, c);
            a.j.length = 0
        },
        mg = function(a, b, c) {
            var d = a.location.host;
            if (N(Ec)) {
                var e = b && ac(b.src, "domain"),
                    f = b && ac(b.src, "network-code");
                if (!d && !e && !f) return lg(c, void 0, new a.Error("no provided or inferred data")), null;
                a = hg(b) ? x("https://pagead2.googlesyndication.com") : x("https://securepubads.g.doubleclick.net");
                return Qa(Ua([a, x("/pagead/ppub_config")]), {
                    ippd: d,
                    pppd: e,
                    pppnc: f
                })
    ...
    a: {
        ...
        var d = new af(null, "gpt_exception", .01);
        bf(d, function(e) {
            e.methodId = 420
        });
        cf(d, function() {
    ...
    [
        ...
        [378648729, null, null, [1]],
        [377085107, null, null, [1]],
        [375794898, null, null, [1]],
        [374653559, null, null, [1]],
        [441, null, null, [1]],
        [371127994, null, null, [1]],
        [377558073, null, null, [1]],
        [375090993, null, null, [1]],
        [20, null, null, null, [
            [
                [1, [
        ...
        [437, null, null, [1]],
        [45352332, null, null, [1]],
        [null, 47, null, [null, 1]],
        [null, null, 2, [null, null, "1-0-38"]],
        [373056377, null, null, [1]],
        ...
        [null, null, null, [null, null, null, ["facebook[.]com", "whatsapp[.]com", "youtube[.]com", "google[.]com", "\\/ads?\\/"]], null, 9]
    ],
    [
        [13, [
            [50, [
        ...
        [3, [
            ...
            [10, [
                ...
                [21064368, [
                    [null, null, null, [null, null, null, ["u_ah", "u_aw"]], null, 489]
                ]],
                [21064369, [
            ...
            [10, [
                [31060396],
                [31060397, null, [4, null, 8, null, null, null, null, ["window.top.frames.google_ads_top_frame"]]],
                [31060398, null, [1, [
                    [4, null, 8, null, null, null, null, ["window.top.frames.google_ads_top_frame"]]
                ]]],
                [31060399, null, [4, null, 8, null, null, null, null, ["window.top.frames.google_ads_top_frame_ctrl"]]],
                [31060400, null, [1, [
                    [4, null, 8, null, null, null, null, ["window.top.frames.google_ads_top_frame_ctrl"]]
                ]]]
            ]],
            [10, [
                [31060411],
            ...
            [1, [
                    [31060544],
                    [31060545, [
                        [null, null, 363931022, [null, null, ""]]
                    ]]
                ],
            ...
            [50, [
                [31061180],
                [31061181, [
                    [370993688, null, null, [1]]
                ]]
            ]],
            [300, [
                [31061184, null, [4, null, 8, null, null, null, null, ["top.frames.google_ads_top_frame"]]],
                [31061185, [
                        [360245596, null, null, [1]]
                    ],
                    [4, null, 8, null, null, null, null, ["top.frames.google_ads_top_frame"]]
                ],
                [31061186, [
            ...
            [1000, [
                    [31061199, null, [4, null, 6, null, null, null, null, ["31061160"]]],
                    [31061200, null, [4, null, 6, null, null, null, null, ["31061161"]]]
                ],
                [4, null, 10]
            ],
            [10, [
            ...
            [10, [
                ...
                [31061702, [
                    [440, null, null, [1]],
                    [378410763, null, null, [1]]
                ]]
            ]],
            [50, [
                [31061719],
                [31061720, [
                    [378899425, null, null, [1]],
                    [377966085, null, null, [1]]
                ]]
            ]],
            [50, [
                [44741898],
        ...
        [5, [
            ...
            [1000, [
                    [31061729, [
                            [null, 24, null, [null, 31061729]],
                            [null, 25, null, [null, 31061729]]
                        ],
                        [6, null, null, 4, null, 2]
                    ],
                    [31061730, [
                            [null, 24, null, [null, 31061730]],
                            [null, 25, null, [null, 31061730]]
                        ],
            ...
            [1000, [
                    [31061734, [
                            [null, 24, null, [null, 31061734]],
                            [null, 25, null, [null, 31061734]]
                        ],
                        [6, null, null, 4, null, 4]
                    ],
                    [31061735, [
                            [null, 24, null, [null, 31061735]],
                            [null, 25, null, [null, 31061735]]
                        ],
            ...
            [100, [
                [31061738],
                [31061739, [
                    [373821891, null, null, [1]]
                ]]
            ]],
            [1000, [
                    [31061743, [
                            [null, 24, null, [null, 31061743]],
                            [null, 25, null, [null, 31061743]]
                        ],
                        [6, null, null, 4, null, 6]
                    ],
                    [31061744, [
                            [null, 24, null, [null, 31061744]],
                            [null, 25, null, [null, 31061744]]
                        ],
            ...
            [10, [
                [31061748],
                [31061749, [
                    [378896074, null, null, [1]]
                ]]
            ]],
            [1000, [
                    [31061750, [
                            [null, 24, null, [null, 31061750]],
                            [null, 25, null, [null, 31061750]]
                        ],
                        [6, null, null, 4, null, 8]
                    ],
                    [31061751, [
                            [null, 24, null, [null, 31061751]],
                            [null, 25, null, [null, 31061751]]
                        ],
        ...
        [12, [
            ...
            [50, [
                [31061217],
                [31061218, [
                    [374326588, null, null, [1]]
                ]]
            ]],
            [50, [
                [31061382],
                [31061383, [
                    [377105258, null, null, [1]]
                ]]
            ]],
            [100, [
                [31061661],
